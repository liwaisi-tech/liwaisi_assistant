...
func TestFireValidate_ValidPassThrough(t *testing.T) {
	...
	err := fireValidate(context.Background(), trans, cpn, consumed)
	if err != nil {
...
func TestFireValidate_NoConsumedTokens(t *testing.T) {
	...
	err := fireValidate(context.Background(), trans, cpn, []Token{})
	if err == nil {
...
func TestFireValidate_ContextCancelled(t *testing.T) {
	...
	err := fireValidate(ctx, trans, cpn, consumed)
...
func TestFireValidate_DispatchIntegration(t *testing.T) {
	...
	err := dispatch(context.Background(), trans, cpn, consumed)
	if err != nil {
...
func TestFireValidate_CorrectionLLMUsesStructuredModel(t *testing.T) {
	...
	_ = fireValidate(context.Background(), trans, cpn, consumed)
