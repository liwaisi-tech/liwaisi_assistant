...
func BuildModelCardList(models []ModelCardListData, locale string) map[string]any {
	return map[string]any{
		...
		"components": map[string]any{
			...
			"btn_inspect":    buttonWithContext("txt_inspect", "inspect_model", "registry_id", "/id", false),
			"btn_toggle":     buttonWithContext("txt_toggle", "toggle_model", "registry_id", "/id", false),
			"btn_setdefault": buttonWithContext("txt_setdefault", "set_default", "registry_id", "/id", false),
			"btn_delete":     buttonWithContext("txt_delete", "delete_model", "registry_id", "/id", false),
...
func buttonWithContext(childID, actionName, ctxKey, ctxPath string, primary bool) map[string]any {
	btn := map[string]any{
		"child": childID,
		"action": map[string]any{
			"name":    actionName,
			"context": []map[string]any{{"key": ctxKey, "value": map[string]any{"path": ctxPath}}},
		},
	}
	if primary {
		btn["primary"] = true
