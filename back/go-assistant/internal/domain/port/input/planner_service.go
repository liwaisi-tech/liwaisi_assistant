...
// PlannerServiceOption defines a functional option for PlannerService methods.
type PlannerServiceOption func(*PlannerServiceOptions)

// PlannerServiceOptions holds configuration for a specific planner execution.
type PlannerServiceOptions struct {
	FailFast bool
}

// WithFailFast per-call option.
func WithFailFast() PlannerServiceOption {
	return func(o *PlannerServiceOptions) {
		o.FailFast = true
	}
}
...
type PlannerService interface {
	...
	Execute(ctx context.Context, sessionID string, graph *entity.PlanGraph, opts ...PlannerServiceOption) (valueobject.PlanResult, error)
